    ...
    <div>
      <div className="flex items-center gap-5">
        <div className="w-[125px] h-[60px] border flex items-center justify-around rounded-lg">
          <button onClick={() => decrement(count)} className="text-xl font-medium text-black">
            -
          </button>
          <p>{count}</p>
          <button onClick={increment} className="text-xl font-medium text-black">
            +
          </button>
        </div>
        <button onClick={handleSubmit} className="w-[215px] h-[60px] border rounded-xl border-black">
          Add To Cart
        </button>
        <ToastContainer />
      </div>
